...
public:
    ...
    MapPoint():
            mnId((unsigned long)(-1)), nObs(0), mbTrackInView(false), mnTrackReferenceForFrame(0),
...
protected:
     ...
     KeyFrame* mpRefKF;
    // -1 stands for null
    unsigned long mnRefKFId = (unsigned long)(-1);
     ...
     MapPoint* mpReplaced;
     // -1 stands for null
     unsigned long mnReplacedId = (unsigned long)(-1);
