...
namespace ORB_SLAM2 {
            ...
            if (CheckNewKeyFrames()) {
                ...
                if (DetectLoop()) {
                    ...
                    if (ComputeSim3()) {
                        ...
                        CorrectLoop();
                        info("Map {} Loop Corrected", mpMap->mnId);
                    }
                }
            }
    ...
    bool LoopClosing::ComputeSim3() {
        ...
        for (int i = 0; i < nInitialCandidates; i++) {
            ...
            info("kf {} and {} has {} matches", mpCurrentKF->mnId, pKF->mnId, nmatches);
