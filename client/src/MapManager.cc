...
unsigned long MapManager::baseMapId = (unsigned long) (-1);
...
void MapManager::MergeMap(Map *pMap1, Map *pMap2, const g2o::Sim3 &T12) {
    ...
    if (pMap1->mpBaseRef && pMap2->mpBaseRef) {
        ...
        if (pMap1->mpBaseRef == nullptr) {
            ...
            auto newT12 = pMap2->mTwl * T12;
            pMap1->SetTransform(newT12);
...
//        RunGlobalBundleAdjustment(pMap1, pMap2);
...
bool MapManager::IsInSameGroup(Map *pMap1, Map *pMap2) {
    if (!pMap1 || !pMap2 || pMap1->groupId == (unsigned long)(-1) || pMap2->groupId == (unsigned long)(-1)) return false;
